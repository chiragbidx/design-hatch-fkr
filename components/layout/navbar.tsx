...
export const Navbar = ({ isLoggedIn = false }: NavbarProps) => {
  ...
  return (
    <header className="shadow-blue-lg shadow-inner bg-opacity-15 w-[90%] md:w-[70%] lg:w-[75%] lg:max-w-screen-xl top-5 mx-auto sticky border border-primary z-40 rounded-2xl flex justify-between items-center p-2 bg-card">
      <Link href="/" className="font-bold text-lg flex items-center">
        <ChevronsDown className="bg-gradient-to-tr from-primary via-blue-500 to-blue-700 border-primary rounded-lg w-9 h-9 mr-2 border text-white shadow-blue-lg" />
        {navbar.brandName}
      </Link>
      {/* <!-- Mobile --> */}
